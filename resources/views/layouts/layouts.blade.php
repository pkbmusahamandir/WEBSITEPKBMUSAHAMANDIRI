...
<head>
    ...
    <title>PKBM Usaha Mandiri</title>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <div class="d-flex gap-3">
                            <a href="https://www.instagram.com/pkbmusahamandiri" target="_blank">
                                <img src="{{ asset('assets/icons/ig.png') }}" height="55" width="55" alt="Instagram" class="rounded-circle bg-white p-1 shadow-sm hover-scale">
                            </a>
                            <a href="https://www.tiktok.com/@pkbmusahamandiri" target="_blank">
                                <img src="{{ asset('assets/icons/tiktok.png') }}" height="55" width="55" alt="Tiktok" class="rounded-circle bg-white p-1 shadow-sm hover-scale">
                            </a>
                            <a href="https://www.youtube.com/@pkbmusahamandiri1596" target="_blank">
                                <img src="{{ asset('assets/icons/yt.png') }}" height="55" width="55" alt="Youtube" class="rounded-circle bg-white p-1 shadow-sm hover-scale">
                            </a>
                            <a href="https://www.facebook.com/share/1G5DWfHzCx/" target="_blank">
                                <img src="{{ asset('assets/icons/fb.png') }}" height="55" width="55" alt="Facebook" class="rounded-circle bg-white p-1 shadow-sm hover-scale">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-2">
                                ...
                                <a href="https://mail.google.com/mail/?view=cm&fs=1&to=pkbmusahamandiri7@gmail.com&su=Permintaan%20Informasi&body=Halo%20PKBM%20Usaha%20Mandiri,%0A%0ASaya%20ingin%20bertanya%20tentang..." target="_blank" class="text-decoration-none text-dark">
                                    pkbmusahamandiri7@gmail.com
                                </a>
