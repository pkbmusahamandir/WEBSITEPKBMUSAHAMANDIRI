<nav class="navbar navbar-expand-lg navbar-light py-3 fixed-top {{ Request::segment(1) == '' ? 'bg-light' : 'bg-white shadow' }}">
    <div class="container">
        ...
        <a class="navbar-brand d-flex align-items-center" href="/">
            <img src="{{ asset('assets/icons/logo.ico') }}" height="45" width="45" alt="Logo" class="me-2">
            <span class="fw-bold">PKBM Usaha Mandiri</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <ul class="navbar-nav mx-auto text-center">
                ...
                <!-- Dropdown Modul -->
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="modulDropdown" role="button"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        Modul
                    </a>
                    <ul class="dropdown-menu text-left" aria-labelledby="modulDropdown">
                        <li><a class="dropdown-item" href="{{ route('modul.a') }}">Paket A</a></li>
                        <li><a class="dropdown-item" href="{{ route('modulB.user') }}">Paket B</a></li>
                        <li><a class="dropdown-item" href="{{ route('user.modul_c') }}">Paket C</a></li>
                    </ul>
                </li>
            </ul>
