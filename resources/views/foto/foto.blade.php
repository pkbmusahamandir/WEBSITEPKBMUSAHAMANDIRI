...
<section style="margin-top: 200px; background-color:#f8f9fa;" class="py-5">
    <div class="container">
        <h2 class="fw-bold mb-4 text-center text-dark">Foto Kegiatan PKBM Usaha Mandiri</h2>
        <p class="text-muted text-center mb-5">Dokumentasi berbagai kegiatan PKBM Usaha Mandiri</p>
        <div class="row g-4">
