            ...
            <div class="col-md-4">
                <div class="card h-100 text-dark shadow-lg border-gradient-black">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Atur dan kelola kegiatan PKBM Usaha Mandiri</p>
            ...
            <div class="col-md-4">
                <div class="card h-100 text-dark shadow-lg border-gradient-black">
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title fw-bold">Modul Paket A</h5>
                        <p class="card-text">Kelola Modul Paket A</p>
                        <a href="{{ route('modul_a.index') }}" class="btn btn-black btn-sm fw-bold">Atur Paket A</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 text-dark shadow-lg border-gradient-black">
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title fw-bold">Modul Paket B</h5>
                        <p class="card-text">Kelola Modul Paket B</p>
                        <a href="{{ route('modul_b.index') }}" class="btn btn-black btn-sm fw-bold">Atur Paket B</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 text-dark shadow-lg border-gradient-black">
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title fw-bold">Modul Paket C</h5>
                        <p class="card-text">Kelola Modul Paket C</p>
                        <a href="{{ route('modul_c.index') }}" class="btn btn-black btn-sm fw-bold">Atur Paket C</a>
                    </div>
                </div>
            </div>
