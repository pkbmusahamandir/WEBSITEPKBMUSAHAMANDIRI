            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $no++ }}</td>
                        <td>
                            <img src="{{ asset('storage/' . $item->image) }}" class="img-thumbnail" style="width: 100px; height: auto;" alt="Foto">
                        </td>
                        <td>{{ $item->judul }}</td>
                        <td>
                            ...
                            <form action="{{ route('photo.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah yakin akan dihapus?')">
                                @csrf
                                @method('DELETE')
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('photo.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="mb-2">
                                                <img src="{{ asset('storage/' . $item->image) }}" height="150" class="img-thumbnail" alt="Photo">
                                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('photo.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="uploadModalLabel">Upload Foto Baru</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
