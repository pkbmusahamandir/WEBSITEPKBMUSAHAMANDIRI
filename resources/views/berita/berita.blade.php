    ...
    <section id="berita" style="margin-top: 100px; background-color:#f8f9fa;" class="py-5">
        <div class="container">
            ...
            <div class="header-berita text-center mb-5">
                <h2 class="fw-bold text-dark">Berita Kegiatan PKBM Usaha Mandiri</h2>
                <p class="text-muted">Update kegiatan terbaru seputar PKBM Usaha Mandiri</p>
            </div>
                ...
                @foreach ($artikels as $item)
                    <div class="col-lg-4 col-md-6">
                        <div class="card border-0 shadow-lg h-100 berita-card">
                            <div class="card-img-top overflow-hidden" style="height: 220px; border-top-left-radius: 12px; border-top-right-radius: 12px;">
                                <img src="{{ asset('storage/' . $item->image) }}" class="img-fluid h-100 w-100 object-fit-cover" alt="gambar {{ $item->judul }}">
                            </div>
                            <div class="card-body p-4 d-flex flex-column">
                                ...
                                <a href="{{ route('blog.detail', ['slug' => $item->slug]) }}" 
                                   class="btn btn-sm mt-3 btn-danger fw-bold align-self-start">
